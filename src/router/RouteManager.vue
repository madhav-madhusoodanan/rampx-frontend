...
<template>
  <header class="">
    <div class="bg-neutral-custom-900 h-full flex flex-row justify-between px-10 md:px-20">
      <img src="/logo-full.svg" height="25" width="132" />
      <nav
      ...
      <button
        class="text-primary-500 lg:hidden my-4"
        @click="isOpen = true"
      >
        <BurgerIcon />
      </button>
